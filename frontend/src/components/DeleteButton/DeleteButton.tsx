...
const DeleteButton: React.FC<Props> = ({ deleteImageHandler }) => {

  const deleteImagePreventPropagation = (e:any) => {
    e.stopPropagation();
    deleteImageHandler();
  }

  return (
    <div className="DeleteButton-overlay">
      <svg
        ...
        onClick={deleteImagePreventPropagation}
      >
        <path
